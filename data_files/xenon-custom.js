...
{public_vars.$pageLoadingOverlay.addClass('loaded');}
setup_sidebar_menu();setup_horizontal_menu();if(public_vars.$mainFooter.hasClass('sticky'))
...
{$(".ckeditor").ckeditor({contentsLangDirection:rtl()?'rtl':'ltr'});}
...
{var $items_with_subs=public_vars.$sidebarMenu.find('li:has(> ul)'),toggle_others=public_vars.$sidebarMenu.hasClass('toggle-others');$items_with_subs.filter('.active').addClass('expanded');$items_with_subs.each(function(i,el)
